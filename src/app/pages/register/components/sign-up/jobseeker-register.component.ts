...
@Component({
  ...
  <section class="flex flex-col gap-7 justify-center items-center bg-slate-200 h-screen">
    ...
    <div class="flex flex-col gap-5">
        ...
        <input class="w-[419px] outline-none h-[59px] rounded-lg p-4 text-[17px]" type="text" placeholder="Наименование компании">
        <input class="w-[419px] outline-none h-[59px] rounded-lg p-4 text-[17px]" type="text" placeholder="Электронная почта">
        <input class="w-[419px] outline-none h-[59px] rounded-lg p-4 text-[17px]" type="text" placeholder="Пароль">
